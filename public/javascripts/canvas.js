...
function init() {
	...
	labels["play"] = new Label({x: 0.5, y: 0.7}, "Jugar!", 144, true, true, false, labelFont, enterQueue);
	labels["searching"] = new Label({x: 0.5, y: 0.7}, "Buscando   ", 144, false, false, false, labelFont);
	...
	labels["waiting"] = new Label({x: 0.5, y: 0.62}, "AWANTA    ", 128, false, false, false, labelFont);
...
var types = ["Fueguito", "Aguita", "Hielito"];
